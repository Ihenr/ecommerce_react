...
const Login = () => {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center overflow-hidden ">
      <div className=" w-1/4 px-6 border-2 border-sky-500 relative rounded-xl ">
        <div className="h-24 w-24 border border-r-amber-50 rounded-full p-3 bg-black">
          <img src={img} alt="logo" className=""></img>
        </div>
        <p className="text-2xl py-5">
          Welcome! Enter your email and Password to continue
        </p>
        <div className=" flex flex-col gap-1 bg-blue-200 rounded-lg p-2 text-[#515151] ">
